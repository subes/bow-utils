...
/**
 * A type-specific {@link java.util.Map}; provides some additional methods that use polymorphism to avoid (un)boxing, and handling of a default return value.
 ...
 * @see java.util.Map
 */
public interface Long2IntMap extends LongMap<Integer> {
    /**
     ...
     * @see Map#entrySet()
     */
    ObjectSet<Entry<Integer>> entrySet();
