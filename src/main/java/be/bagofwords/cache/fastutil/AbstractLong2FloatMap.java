 ...
 */
public abstract class AbstractLong2FloatMap implements Long2FloatMap, java.io.Serializable {
     ...
     */
    public static class BasicEntry implements LongMap.Entry<Float> {
        protected long key;
        ...
        public boolean equals(final Object o) {
            ...
            return ((key) == (((((Long) (e.getKey())).longValue())))) && ((value) == (((((Float) (e.getValue())).floatValue()))));
        }
        ...
        return new AbstractLongSet() {
            ...
            public LongIterator iterator() {
                return new AbstractLongIterator() {
                    final ObjectIterator<Entry<Float>> i = entrySet().iterator();
    ...
    public ObjectSet<Entry<Float>> entrySet() {
    ...
    public int hashCode() {
        int h = 0, n = size();
        final ObjectIterator<? extends Entry<Float>> i = entrySet().iterator();
