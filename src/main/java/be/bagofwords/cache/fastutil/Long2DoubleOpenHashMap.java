...
public class Long2DoubleOpenHashMap extends AbstractLong2DoubleMap implements java.io.Serializable, Cloneable, Hash {
    ...
    public Double put(final long k, final Double ov) {
    ...
    public boolean containsValue(final Double ov) {
        double v = ov;
     ...
     * the map
     */
    private final class MapEntry implements Long2DoubleMap.Entry<Double> {
    ...
    private class MapIterator {
        ...
        {
            final boolean used[] = Long2DoubleOpenHashMap.this.used;
        ...
        public void remove() {
            ...
            if (pos < -1) {
                ...
                Long2DoubleOpenHashMap.this.remove(wrapped.getLong(-pos - 2));
                last = -1;
                return;
            }
            size--;
    ...
    private final class MapEntrySet extends AbstractObjectSet<Entry> implements FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            while (used[pos]) {
                if (((key[pos]) == (k))) {
                    Long2DoubleOpenHashMap.this.remove(e.getKey());
                    return true;
                }
                pos = (pos + 1) & mask;
            }
