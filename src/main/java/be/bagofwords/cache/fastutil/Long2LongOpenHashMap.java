...
public class Long2LongOpenHashMap extends AbstractLong2LongMap implements java.io.Serializable, Cloneable, Hash {
    ...
    public Long put(final long k, final Long ov) {
        final long v = ov;
        // The starting point.
    ...
    public boolean containsValue(final Long obj) {
        long v = obj;
     ...
     * the map
     */
    private final class MapEntry implements Entry<Long> {
    ...
    private class MapIterator {
        ...
        {
            final boolean used[] = Long2LongOpenHashMap.this.used;
        ...
        public void remove() {
            ...
            if (pos < -1) {
                ...
                Long2LongOpenHashMap.this.remove(wrapped.getLong(-pos - 2));
                last = -1;
                return;
            }
            size--;
    ...
    private final class MapEntrySet extends AbstractObjectSet<Entry> implements FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            while (used[pos]) {
                if (((key[pos]) == (k))) {
                    Long2LongOpenHashMap.this.remove(e.getKey());
                    return true;
                }
                pos = (pos + 1) & mask;
            }
