...
public abstract class AbstractLong2IntMap implements Long2IntMap, java.io.Serializable {
     ...
     */
    public static class BasicEntry implements Entry<Integer> {
        protected long key;
        protected int value;
        ...
        return new AbstractLongSet() {
            ...
            public LongIterator iterator() {
                return new AbstractLongIterator() {
                    final ObjectIterator<Entry<Integer>> i = entrySet().iterator();
    ...
    public ObjectSet<Entry<Integer>> entrySet() {
    ...
    public int hashCode() {
        int h = 0, n = size();
        final ObjectIterator<? extends Entry<Integer>> i = entrySet().iterator();
