...
public class Long2FloatOpenHashMap extends AbstractLong2FloatMap implements java.io.Serializable, Cloneable, Hash {
    ...
    public Float put(final long k, final Float ov) {
    ...
    public boolean containsValue(final Float ov) {
        float v = (Float) ov;
     ...
     * the map
     */
    private final class MapEntry implements Long2FloatMap.Entry<Float> {
    ...
    private class MapIterator {
        ...
        {
            final boolean used[] = Long2FloatOpenHashMap.this.used;
        ...
        public void remove() {
            ...
            if (pos < -1) {
                ...
                Long2FloatOpenHashMap.this.remove(wrapped.getLong(-pos - 2));
                last = -1;
                return;
            }
            size--;
    ...
    private final class ValueIterator extends MapIterator implements FloatIterator {
        ...
        public Float next() {
            return (Float.valueOf(value[nextEntry()]));
        }
    }
