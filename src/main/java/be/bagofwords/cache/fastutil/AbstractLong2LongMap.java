 ...
 */
public abstract class AbstractLong2LongMap implements Long2LongMap, java.io.Serializable {
     ...
     */
    public static class BasicEntry implements Long2LongMap.Entry<Long> {
        protected long key;
        ...
        return new AbstractLongSet() {
            ...
            public LongIterator iterator() {
                return new AbstractLongIterator() {
                    final ObjectIterator<Entry<Long>> i = entrySet().iterator();

                    public long nextLong() {
                        return ((Long2LongMap.Entry) i.next()).getKey();
                    }
    ...
    public ObjectSet<Entry<Long>> entrySet() {
    ...
    public int hashCode() {
        int h = 0, n = size();
        final ObjectIterator<? extends Entry<Long>> i = entrySet().iterator();
