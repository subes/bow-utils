...
public class RemoteObjectUtil {
    ...
    public static Object loadObject(PackedRemoteObject packedRemoteObject) {
        return loadObject(packedRemoteObject, null);
    }

    public static Object loadObject(PackedRemoteObject packedRemoteObject, RemoteLogFactory remoteLogFactory) {
        try {
            RemoteObjectClassLoader classLoader = new RemoteObjectClassLoader(packedRemoteObject, RemoteObjectUtil.class.getClassLoader(), remoteLogFactory);
